...
import { Trophy, Activity, Zap, Shield, FileCheck, Calendar, FileDown, Search, AlertCircle, Clock, ChevronDown, ChevronUp, Sparkles, Loader2, Award } from 'lucide-react';
import { storageService } from '../services/storageService';
import { aiService } from '../services/aiService';
import { Pilot, Category, Status, RaceResult, Penalty } from '../types';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {view === 'penalizaciones' && (
          <div className="space-y-6 animate-in fade-in">
             <div className="bg-red-600/10 border border-red-500/20 p-8 rounded-[2rem] flex items-center gap-6">
                <AlertCircle className="text-red-500" size={32} />
                <div>
                   <h4 className="text-white font-black uppercase oswald text-xl">Tablero de Sanciones FRAD</h4>
                   <p className="text-zinc-500 text-[10px] font-black uppercase tracking-widest">Resoluciones oficiales del comisariado deportivo</p>
                </div>
             </div>
             <div className="glass-panel p-20 rounded-[3rem] text-center">
