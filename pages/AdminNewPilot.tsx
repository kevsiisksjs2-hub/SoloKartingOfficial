...
const AdminNewPilot: React.FC = () => {
  ...
  const validate = () => {
    ...
    if (!formData.number) newErrors.number = "El dorsal es obligatorio";
    if (isNaN(Number(formData.number)) || Number(formData.number) <= 0) {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-zinc-300 pb-20 font-sans">
      <div className="bg-zinc-900 border-b border-zinc-800 sticky top-0 z-50">
        <div className="max-w-4xl mx-auto px-6 h-20 flex items-center justify-between">
          <button 
            ...
            className="flex items-center gap-2 text-zinc-500 hover:text-white transition-colors font-black uppercase text-[10px] tracking-widest"
          >
            <ChevronLeft size={18} /> Volver al Dashboard
          </button>
          <div className="bg-red-600 px-3 py-1 rounded italic font-black text-white text-sm oswald">
            KDO ADMIN
          </div>
        </div>
      </div>
      ...
      <main className="max-w-4xl mx-auto px-6 mt-12">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <section className="bg-zinc-900 border border-zinc-800 rounded-[2.5rem] p-10 shadow-2xl">
            <h3 className="text-sm font-black uppercase text-red-500 tracking-[0.2em] mb-8 flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-2">
                ...
                <input 
                  ...
                  className={`w-full bg-zinc-950 border rounded-xl px-6 py-4 text-white font-bold uppercase outline-none transition-all ${errors.name ? 'border-red-600 bg-red-600/5' : 'border-zinc-800 focus:border-red-600'}`}
              ...
              <div className="space-y-2">
                ...
                <select 
                  ...
                  className={`w-full bg-zinc-950 border rounded-xl px-6 py-4 text-white font-bold uppercase outline-none cursor-pointer appearance-none ${errors.category ? 'border-red-600' : 'border-zinc-800 focus:border-red-600'}`}
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="space-y-2">
                ...
                <div className="relative">
                  <span className="absolute left-4 top-1/2 -translate-y-1/2 text-red-600 font-black oswald text-xl">#</span>
                  <input 
                    type="text" 
                    value={formData.number}
                    onChange={e => setFormData({...formData, number: e.target.value.replace(/\D/g, '')})}
                    className={`w-full bg-zinc-950 border rounded-xl pl-10 pr-6 py-4 text-white font-black oswald text-2xl outline-none transition-all ${errors.number ? 'border-red-600' : 'border-zinc-800 focus:border-red-600'}`}
                    placeholder="00"
                  />
                </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className={`w-full bg-zinc-950 border rounded-xl pl-12 pr-6 py-4 text-white font-mono text-sm outline-none transition-all ${errors.transponderId ? 'border-red-600' : 'border-zinc-800 focus:border-red-600'}`}
              ...
              <div className="space-y-2">
                ...
                <input 
                  ...
                  className={`w-full bg-zinc-950 border rounded-xl px-6 py-4 text-white font-black oswald text-xl outline-none transition-all ${errors.ranking ? 'border-red-600' : 'border-zinc-800 focus:border-red-600'}`}
                />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-2">
                ...
                <input 
                  ...
                  className={`w-full bg-zinc-950 border rounded-xl px-6 py-4 text-white font-bold outline-none transition-all ${errors.medicalLicense ? 'border-red-600' : 'border-zinc-800 focus:border-red-600'}`}
                  placeholder="000000"
                />
              ...
              <div className="space-y-2">
                ...
                <input 
                  ...
                  className={`w-full bg-zinc-950 border rounded-xl px-6 py-4 text-white font-bold outline-none transition-all ${errors.sportsLicense ? 'border-red-600' : 'border-zinc-800 focus:border-red-600'}`}
                  placeholder="000000"
                />
              ...
              <div className="space-y-2">
                ...
                <select 
                  ...
                  className="w-full bg-zinc-950 border border-zinc-800 rounded-xl px-6 py-4 text-white font-bold uppercase outline-none cursor-pointer"
                >
          ...
          <div className="flex justify-end gap-4 mt-12">
            ...
            <button 
              ...
              className="bg-red-600 hover:bg-red-700 text-white px-12 py-5 rounded-2xl font-black uppercase text-xs shadow-2xl shadow-red-600/30 transition-all flex items-center gap-3 transform hover:scale-[1.02] active:scale-95 disabled:opacity-50"
            >
              {isSubmitting ? (
                <>Procesando...</>
              ) : (
      ...
      <div className="fixed bottom-0 left-0 w-full bg-zinc-950 border-t border-zinc-800 py-3 px-8 flex items-center justify-center gap-4 text-[8px] font-black text-zinc-700 uppercase tracking-[0.4em]">
